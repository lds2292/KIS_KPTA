...
type
  ...
  public
    procedure Run(DOC_NO : String;bPreview : Boolean=True);
...
procedure TQR_KPTA_NORMAL_PRN_frm.Run(DOC_NO: String; bPreview: Boolean);
begin
  FDOC_NO := DOC_NO;
  try
    try
...
procedure TQR_KPTA_NORMAL_PRN_frm.TitleBand1AfterPrint(
...
begin
  ...
  begin
    If not qryMakeforPrint.Eof Then
      QR_SUB_LASTLINE.Enabled := FTOTAL_HEIGHT + Sender.Height >= 1122
    else
      QR_SUB_LASTLINE.Enabled := FTOTAL_HEIGHT + ChildBand1.Height >= 1122;
  end;
end;
